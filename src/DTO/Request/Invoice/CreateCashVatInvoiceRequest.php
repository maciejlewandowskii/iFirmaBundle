...
final readonly class CreateCashVatInvoiceRequest
{
    public function __construct(
        #[SerializedName('TypRozliczenia')]
        #[Assert\NotNull]
        public CashVatSettlementType $settlementType,
        ...
        #[SerializedName('KursSprzedDatySprzedazy')]
        #[Assert\PositiveOrZero]
        public ?float $exchangeRateOnSaleDate = null,
