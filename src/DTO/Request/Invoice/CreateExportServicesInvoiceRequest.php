...
final readonly class CreateExportServicesInvoiceRequest
{
    public function __construct(
        #[SerializedName('NazwaUslugi')]
        #[Assert\NotBlank]
        #[Assert\Length(min: 1, max: 300)]
        public string $serviceName,

        #[SerializedName('UslugaSwiadczonaTrybArt28b')]
        public bool $serviceUnderArt28b,
        ...
        #[SerializedName('DataObowiazkuPodatkowego')]
        #[Assert\NotBlank]
        #[Assert\Date]
        public string $taxObligationDate,
        ...
        #[SerializedName('ProceduryJpk')]
        #[Assert\Valid]
        public ?JpkProceduresRequest $jpkProcedures = null,
